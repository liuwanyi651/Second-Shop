    ...
    <div class="one">
        ...
        <table class="tab">
            <tr v-for="(itme,index) in floor1" :key="index" style="width:183px;" :class="{'box':index===0}" @click="goto(item)">
                <img :src="itme.image" style="width:185px;" @click="foodOne(itme)">
            </tr>
        </table>
    </div>
    <!--2楼新鲜水果-->
    <div class="one">
        ...
        <table class="tab">
            <tr v-for="(itme,index) in floor2" :key="index" style="width:183px;" :class="{'box':index===0}">
                <img :src="itme.image" style="width:185px;" @click="foodTwo(itme)">
            </tr>
        </table>
    </div>
    <!--3楼营养奶品-->
    <div class="one">
        ...
        <table class="tab">
            <tr v-for="(itme,index) in floor3" :key="index" style="width:183px;" :class="{'box':index===0}">
                <img :src="itme.image" style="width:185px;" @click="foodThree(itme)">
            </tr>
        </table>
    </div>
</div>
