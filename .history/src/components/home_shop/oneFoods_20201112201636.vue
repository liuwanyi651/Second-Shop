...
<div>
    ...
    <div class="one">
        ...
        <table class="tab">
            <tr v-for="(itme,index) in floor1" :key="index" style="width:183px;" :class="{'box':index===0}" @click="goFoods(floor1.item.goodsId)">
...
export default {
    ...
    methods: {
        ...
        goFoods(floor1) {
            console.log(floor1.item.goodsId); //从首页点击某一项热销商品 获取到对象 对象里有相应的值
