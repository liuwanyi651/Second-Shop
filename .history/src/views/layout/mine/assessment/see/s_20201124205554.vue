<template>
  <div>
    ...
    <div style="display: flex">
      ...
      <div>
        <div style="margin: 20px 10px">{{ name.nickname }}</div>
    ...
    <div class="alt">
      ...
      <div class="icon" @click="join"><van-icon name="cart-o" /></div>
    </div>
    <div class="button">
...
export default {
  ...
  methods: {
    ...
    join(){
        this.$api.shop(this.list.cid).then(res => {
            console.log(res)
        })
    }
  },
