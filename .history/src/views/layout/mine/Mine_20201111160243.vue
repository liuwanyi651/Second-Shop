...
<div>
    ...
    <div class="hi flex j-center a-center">
        <!--头部头像部分-->
        <div class="head">
            <!--设置按钮-->
    ...
    <div>
        <van-grid :column-num="5">
            ...
            <van-grid-item icon="thumb-circle-o" text="评价" badge="5" />
            <van-grid-item icon="like-o" text="已完成" />
        </van-grid>
    </div>
    <!--全部订单等 使用cell路由跳转组件 to后面跟我们要跳转的页面-->
    <div>
        <van-cell title="全部订单" icon="location-o" is-link to="index" />
        <van-cell title="收藏商品" icon="location-o" is-link to="index" />
        <van-cell title="地址管理" icon="location-o" is-link to="index" />
        <van-cell title="最近浏览" icon="location-o" is-link to="index" />
    </div>
</div>
</template>
