...
<div>
    ...
    <div class="hi flex j-center a-center">
        ...
        <div class="head">
            ...
            <div class="cw fs14  t-center ">
                <van-button plain type="warning" size="mini">退出登录</van-button>
            </div>
        </div>
    </div>
    <!--待付款横排样式-->
    ...
    <div>
        ...
        <van-cell title="收藏商品" icon="star-o" is-link to="index" />
        <van-cell title="地址管理" icon="location-o" is-link to="index" />
        <van-cell title="最近浏览" icon="eye-o" is-link to="index" />
    </div>
</div>
</template>
