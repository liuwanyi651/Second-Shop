        ...
        <div v-if="list.length>0" class="all">
            <div  style=" display: flex; justify-content: space-between;">
                <div  style=" display: flex; "> 
                    ...
                    <van-checkbox v-model="checked" shape="round"  @click="select"  checked-color="red" ></van-checkbox>
                    </div>
                ...
                <div>
                    ...
                    <div style=" display: flex;">
                            ...
                            <van-button type="danger" size="small" class="pdl10">删除</van-button>
            ...
            <div v-for="(item,index) in list" :key="index">
                <div class="flex">
                    <div style=" width: 40px;" class="flex j-center">
                        <van-checkbox v-model="item.check" @change="fx(item)" shape="round"  checked-color="red"></van-checkbox>
                    </div>
            ...
            <!--<div>
                <van-submit-bar :price="3050" button-text="提交订单" @submit="onSubmit">
                    <van-checkbox v-model="checked">全选
                    </van-checkbox>
                       <van-button round  size="small" type="danger">确认删除</van-button>
                </van-submit-bar> 
            </div>-->
        </div>
        <!--第三种登录没购物的状态-->
