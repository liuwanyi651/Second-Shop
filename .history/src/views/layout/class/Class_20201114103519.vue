    ...
    <div class="flex">
        ...
        <div class="top">
            ...
            <van-tabs v-model="active" @click="aboveChange" class="pd8 ">
                ...
                <van-tab style=" width: 279px;
                overflow: hidden;" v-for="(item,index) in classQuery" :key="index" :title="item.mallSubName" :name="item.mallSubId" swipeable>
                    <!--拿到每一项的对应的详细的商品 下面图片-->
                    <div v-for="(item,index) in goodsData" :key="index">
                        <div class="picIimg bs"><img :src="item.image" alt=""></div>
                    </div>
                </van-tab>
            </van-tabs>
        </div>
