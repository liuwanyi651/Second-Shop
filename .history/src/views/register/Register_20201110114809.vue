    ...
    <div class="bg">
        <div class="box">
            ...
            <van-form @submit="onSubmit" class="form">
                ...
                <!--手机号-->
                <van-field v-model="tel" type="tel" label="手机号码" placeholder="仅注册需要" :rules="[{ required: true, message: '请填写用户名' }]" />
                <!--短信验证-->
                <div class="flex a-center">
                    <van-field v-model="note" type="note" label="短信验证" placeholder="仅注册需要" :rules="[{ required: true, message: '请填写用户名' }]" />
                    <van-button type="primary" class="note_butn">发送验证码</van-button>
                </div>
                <!--验证码-->
                <div class="flex a-center">
                    <van-field v-model="code" type="code" label="验证码" placeholder="请输入验证码" :rules="[{ required: true, message: '请填写用户名' }]" />
