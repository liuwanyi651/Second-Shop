...
const routes = [
  ...
  },
  {
    ...
    component:() =>import('../views/ordermoney/orderMoney'),
    meta:{
      title:'订单结算'
    }
  },
  ...
  {
    path: '/addsite', 
    name: 'addsite', //这是 我的-地址管理
    component:() =>import('../views/layout/mine/addsite/addsite.vue'),
    meta:{
      title:'地址管理'
    }
  },
  ...
  {
    path: '/editsite', 
    name: 'editsite', //这是 我的-地址-编辑地址
    component:() =>import('../views/layout/mine/addsite/editsite/editsite.vue'),
    meta:{
      title:'地址编辑'
    }
  },
  {
    path: '/assessment', 
    name: 'assessment', //这是 我的-评价
    component:() =>import('../views/layout/mine/assessment/assessment.vue'),
    meta:{
      title:'评价'
    }
  },
  {
    path: '/score', 
    name: 'score', //这是 我的-评价-晒单评价
    component:() =>import('../views/layout/mine/assessment/score/score.vue'),
    meta:{
      title:'晒单评价'
    }
  },
  {
    path: '/see', 
    name: 'see', //这是 我的-评价-查看评价
    component:() =>import('../views/layout/mine/assessment/see/see.vue'),
    meta:{
      title:'查看评价'
    }
  },
